...
Если при подключении флеш-карты **microSD** к ПК через адаптер появляется ошибка с текстом `The file or directory is corrupted and unreadable`:

- Вставьте флешку в Nintendo Switch
- Запустите консоль в _Home Menu_
- Откройте **Системные настройки** > **Система**
- Пролистайте вниз до **Параметры форматирования**
- Выберите пункт **Форматировать карту microSD**